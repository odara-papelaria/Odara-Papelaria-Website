...
import { backgroundFornecedor, iconeClosed, imageFornecedor, Logo } from '../../assets/images';

export const Container = styled.body`
    flex: 1;
    background-image: url(${backgroundFornecedor});
`;
...
export const ImageFuncao = styled.div`
    ...
    background-size: 100%; 
    background-position: center;
    background-image: url(${imageFornecedor});
